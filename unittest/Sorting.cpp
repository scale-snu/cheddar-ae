...
TEST_P(Testbed, Sorting) {
  ...
  // Preparation
  Compare<word> compare(boot_context, max_level, num_boot_per_iter, g_iter,
                        f_iter);
  ...
  __ProfileStart("Sorting", warm_up, EncodeAndEncrypt(input, msg, max_level));
